...
@Component({
  selector: 'app-iso20022-xml-details',
  templateUrl: './iso20022-xml-details.component.html',
  styleUrls: ['./iso20022-xml-details.component.css']
})
export class Iso20022XmlDetailsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private iso20022JSONService: SchemeIso20022XmlService
  ) {}
