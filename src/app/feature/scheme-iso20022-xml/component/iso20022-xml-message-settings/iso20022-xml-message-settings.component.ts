...
@Component({
  selector: 'app-iso20022-xml-message-settings',
  templateUrl: './iso20022-xml-message-settings.component.html',
  styleUrls: ['./iso20022-xml-message-settings.component.css']
})
export class Iso20022XmlMessageSettingsComponent implements OnInit {
  endpointItems: any[] = [];
  searchTerm: string = '';
