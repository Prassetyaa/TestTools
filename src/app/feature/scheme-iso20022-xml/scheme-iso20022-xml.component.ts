...
@Component({
  selector: 'app-scheme-iso20022-xml',
  templateUrl: './scheme-iso20022-xml.component.html',
  styleUrls: ['./scheme-iso20022-xml.component.css']
})
export class SchemeIso20022XmlComponent implements OnInit {
